...
public class DBMigrationUtilV2ActivityAssignment {
	...
	public static void init(){
		new DBMigrationUtilV2ActivityAssignment();
	}
	...
	public static void updateUserDetails(Sheet datatypeSheet){
		...
		List<ActivityAssignnmentBean> allActivityAssignnmentsToUpdate = new ArrayList<ActivityAssignnmentBean>();
