...
///////////////////////////////////////// Activity query //////////////////////////////////////////////////////////////////////////////////////
 ...
 "on companyWithPerDate.companyId = activity.companyId and companyWithPerDate.activityId = activity.activityId  order by periodicityDateId desc) newtable where month(duedate)=? and year(duedate)=?;";
	...
	private String activityCountByLaw = "set session sql_mode='TRADITIONAL';select activityStatus,count(activityStatus) as count,lawmaster.lawId,lawmaster.lawname from lawmaster join (" +
