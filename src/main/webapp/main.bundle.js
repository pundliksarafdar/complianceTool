...
module.exports = "<section class=\"content report\">\r\n      <!-- Info boxes -->\r\n      <div class=\"row top-buffer\">\r\n        \r\n\r\n\t\r\n\t<table class=\"table table-striped table-sm table-curved risk-table\">\r\n\t<thead class=\"thead-dark\">\r\n\t<tr>\r\n\t<th class=\"tableheading\">Abbreviation</th>\r\n\t<th class=\"tableheading\">Location</th>\r\n\t<th class=\"tableheading\">Law Description</th>\r\n\t<th class=\"tableheading\">Activity Name</th>\r\n\t<th class=\"tableheading\">Periodicity Due Date</th>\r\n\t<th class=\"tableheading\">Period Description</th>\r\n\t<th class=\"tableheading\">Actvity Assign User</th>\r\n\t<th class=\"tableheading\"></th>\r\n\t</tr>\r\n\t</thead>\r\n\t<tbody>\r\n\t<tr *ngFor=\"let activity of activityData\">\r\n      <td>{{activity.abbriviation}}</td>\r\n      <td>{{activity.locationName}}</td>\r\n      <td>{{activity.lawDesc}}</td>\r\n      <td>{{activity.activityName}}</td>\r\n      <td>{{activity.duedate}}</td>\r\n      <td>{{activity.periodicityDesc}}</td>\r\n      <td>{{activity.locationName}}</td>\r\n      <td *ngIf=\"activity.isComplied\">Complied</td>\r\n\t  <td *ngIf=\"!activity.isComplied\"><input type='button' value='Comply' title='Change status to complied' (click)=\"changeStatus(activity.activityId,activity.companyId,$event)\" /></td>\r\n    </tr>      \r\n</tbody>\r\n\t</table>\r\n\t</div>\r\n\t\r\n\r\n\r\n\r\n\r\n    </section>"
...
var ComplianceActivitiesComponent = /** @class */ (function () {
    function ComplianceActivitiesComponent(activityService) {
        this.activityService = activityService;
    }
    ComplianceActivitiesComponent.prototype.changeStatus = function (activityId, companyId, event) {
        console.log(activityId, companyId, event);
        this.activityService.setActivityStatus(activityId, companyId).then(function (resp) {
    ...
    ComplianceActivitiesComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__service_activityService__["a" /* ActivityService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__service_activityService__["a" /* ActivityService */]])
...
var ComplianceDashboardComponent = /** @class */ (function () {
    function ComplianceDashboardComponent(dashboardService) {
    ...
    ComplianceDashboardComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    ...
    ComplianceDashboardComponent.prototype.ngOnInit = function () {
        ...
        this.dashboardService.getDashboardData(data[0].companyId).then(function (response) { _this.buildDashBoard(response); })
    ...
    ComplianceDashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__service_dashboardService__["a" /* DashboardService */]])
...
var ComplianceReportComponent = /** @class */ (function () {
    function ComplianceReportComponent(reportService) {
        ...
        this.reportCompany = this.companySet[0]['companyId'];
        this.activities = [];
    ...
    ComplianceReportComponent.prototype.selectAvtivities = function (activity) {
        if (activity == "open") {
            ...
            __WEBPACK_IMPORTED_MODULE_2_jquery__('.openactivities').css('display', 'none');
    ...
    ComplianceReportComponent.prototype.getReportData = function () {
        ...
        if (this.view == 'month') {
            ...
            freqency = this.yearSet[this.reportYear];
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__service_activityService__ = __webpack_require__("./src/app/service/activityService.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ComplienceCalendarComponent = /** @class */ (function () {
    function ComplienceCalendarComponent(modal, activityService) {
        var _this = this;
        this.modal = modal;
        this.activityService = activityService;
        this.view = 'month';
    ...
    ComplienceCalendarComponent.prototype.ngOnInit = function () {
        ...
        var companies = sessionStorage.getItem('companies');
        var data = JSON.parse(companies);
        this.activityService.getActivityData(data[0].companyId).then(function (response) { _this.buildActivityCalander(response); })
            .catch(function (err) { _this.handleError(err); });
    };
    ...
    ComplienceCalendarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__service_activityService__["a" /* ActivityService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */], __WEBPACK_IMPORTED_MODULE_4__service_activityService__["a" /* ActivityService */]])
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__service_loginService__["a" /* LoginService */], __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]])
    ], RegisterComponent);
