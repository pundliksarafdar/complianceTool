...
public class DBMigrationUtilV2ActivityAssociationUpload {
	...
	public static void init(){
		new DBMigrationUtilV2ActivityAssociationUpload();
	}
	
	public static void createActivityAssociation(Sheet datatypeSheet,int activityCountStart){
