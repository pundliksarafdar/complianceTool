...
public class FileUpoadUtil {
	...
	private static void removeAlreadyUploadedFiles() throws ClientProtocolException, IOException{
		String folderLocation = "";
		CloseableHttpClient httpclient = HttpClients.createDefault();
		HttpGet httpGet = new HttpGet("http://jws-app-indcopli.4b63.pro-ap-southeast-2.openshiftapps.com/ComplianceTool/rest/file/listAllFiles");
