...
public class NotificationManager {
    ...
    public boolean assignNotificationForUserOfLocationAndLaw(String lawId, List<String> location, int year, int notificationId, List<String> userType, Boolean isAllLocation) {
